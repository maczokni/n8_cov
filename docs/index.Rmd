...
# Less concentration of calls


```{r giniASB, fig.width=11,fig.height=7}
...
- Expressions of concern
- Calls for advice
- Presence of guardians and absence of targets
- Violence drop
...
- Consider efficiencies (reduced time on scene)
